...
import {  Code2,  ImageIcon, LayoutDashboard, MessageSquare,  Music2,  SettingsIcon, VideoIcon } from 'lucide-react';
  ...
  return (
    <div className='spac-y-4 py-4 flex flex-col h-full bg-[#111827] text-white'>
        <div className='px-3 py-2 flex-1'>
            ...
            <h1 className={cn ('text-2xl font-bold',montserrat.className)}>VAST AI</h1>
            </Link>
            <div>
                {routes.map((route)=>(
